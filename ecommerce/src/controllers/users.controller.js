...
class UserController {
    ...
    upgradeToPremiun = async (req, res) => {
        try {
            ...
            // SE VERIFICA SI SE CARGARON TODOS LOS DOCUMENTOS REQUERIDOS //
    ...
    uploadDocuments = async (req, res) => {
        try {
            ...
            // SE OBTIENE EL USUARIO Y SE AGREGAN LOS DOCUMENTOS NECESARIOS //
            const user = await userService.getUser(uid)
            if (!user) {
            ...
            // SE ACTUALIZA EL USUARIO CON LOS NUEVOS DOCUMENTOS //
